...
# valid_chars = {comma, period, semicolon, space}
# valid_chars.update(range(lower, upper))
# valid_chars.update(range(Lower, Upper))
...
#                 else:
#                     curr_elem = c ^ nums[i]
#                 if curr_elem not in valid_chars:
#                     to_be_exited = True
#                     break
#                 else:
#                     curr_list.append(curr_elem)
#             if to_be_exited:
#                 continue
#             print(a, b, c, "".join(map(chr, curr_list)))
